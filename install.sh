...
function install_origin_environment() {
	...
	run_step "Cloning origin-js" \
		git clone https://github.com/OriginProtocol/origin-js.git --branch stable || true

	run_step "Cloning origin-bridge" \
		git clone https://github.com/OriginProtocol/origin-bridge.git --branch stable || true

	run_step "Cloning origin-dapp" \
		git clone https://github.com/OriginProtocol/origin-dapp.git --branch stable || true
...
function install_website_environment() {
	...
	run_step "Cloning origin-website" \
		git clone https://github.com/OriginProtocol/origin-website.git --branch stable || true
